...
describe Device do
  ...
  before {
    ...
    @first_sensor = Sensor.create(device_id: flukso.id, uuid: '99665678901234599912345678901234', name: 'Sensor 1', sensor_type_unit_id: sensor_type_unit.id, min_value: 0, max_value: 1000)
    ...
    @second_sensor = Sensor.create(device_id: raspberry_pi.id, uuid: '12345678901234512345678909999966', name: 'Sensor 2', sensor_type_unit_id: sensor_type_unit.id, min_value: 0, max_value: 1000)
    ...
    @aggregate_sensor = Sensor.create(device_id: aggregate_device.id, uuid: '49123911234597890902345678996656', name: 'Sensor 3', sensor_type_unit_id: sensor_type_unit.id, min_value: 0, max_value: 1000)
    Device.aggregate
  }
