...
Sensor.create(uuid: '00000000000000000000000000000000', sensor_type: sensor_type1, name: 'First Floor', device_id: device1.id, unit_id: unit1.id)
Sensor.create(uuid: '11111111111111111111111111111111', sensor_type: sensor_type1, name: 'Second Floor', device_id: device1.id, unit_id: unit1.id)
Sensor.create(uuid: '22222222222222222222222222222222', sensor_type: sensor_type2, name: 'Roof PV Plant', device_id: device2.id, unit_id: unit1.id)
Sensor.create(uuid: '33333333333333333333333333333333', sensor_type: sensor_type2, name: 'Backyard PV Plant', device_id: device2.id, unit_id: unit1.id)
Sensor.create(uuid: '44444444444444444444444444444444', sensor_type: sensor_type3, name: 'Thermostat', device_id: device3.id, unit_id: unit2.id)
Sensor.create(uuid: '55555555555555555555555555555555', sensor_type: sensor_type1, name: 'Equipment', device_id: device3.id, unit_id: unit1.id)
