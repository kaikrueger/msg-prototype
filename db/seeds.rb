...
Sensor.create(uuid: '44444444444444444444444444444444', sensor_type: sensor_type3, name: 'Thermostat', device_id: device3.id)
Sensor.create(uuid: '55555555555555555555555555555555', sensor_type: sensor_type1, name: 'Equipment', device_id: device3.id)
